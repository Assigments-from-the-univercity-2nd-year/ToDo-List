...
class TextPartDataDaoTest {
    ...
    private suspend fun addTextPartDatasToDatabase() {
        dao.addTextPart(TextPartDbModel("a name", 1, 1L))
        dao.addTextPart(TextPartDbModel("a name", 2, 1L))
        dao.addTextPart(TextPartDbModel("a name", 5, 1L))
        dao.addTextPart(TextPartDbModel("a name", 1, 2L))
        dao.addTextPart(TextPartDbModel("a name", 1, 3L))
        dao.addTextPart(TextPartDbModel("a name", 2, 2L))
        dao.addTextPart(TextPartDbModel("a name", 6, 1L))
    }
