...
import com.example.todolist.ui.SortOrder
...
interface TaskDao {
    ...
    @Query("SELECT * FROM task WHERE (isCompleted != :hideCompleted OR isCompleted = 0) AND name LIKE '%' || :searchQuery || '%' ORDER BY isImportant DESC, createdDate")
