...
sealed class Component {
    ...
    abstract suspend fun delete(folderDao: FolderDbModelDao, taskDao: TaskDbModelDao)
    abstract suspend fun deleteCompleted(folderDao: FolderDbModelDao, taskDao: TaskDbModelDao)
}
...
data class Folder(
    ...
    override suspend fun delete(folderDao: FolderDbModelDao, taskDao: TaskDbModelDao) {
    ...
    override suspend fun deleteCompleted(folderDao: FolderDbModelDao, taskDao: TaskDbModelDao) {
    ...
    suspend fun updateDate(folderDao: FolderDbModelDao) {
        folderDao.updateFolder(this.copy(modifiedDate = System.currentTimeMillis()))
    }

    suspend fun setNumberOfSubComponents(folderDao: FolderDbModelDao, taskDao: TaskDbModelDao) {
